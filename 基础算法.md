...
![image-20230325212002792](基础算法.assets/image-20230325212002792.png)

**差分是前缀和的逆运算**

构建一个原数组的差分b,对于[l,r]整体元素+c,只需要在差分数组中修改两个位置:
...
邻接表为每个节点建立一个链表,内容是该节点可以指向的节点,在插入新边`2->3`时,在2的链表采用头插法
